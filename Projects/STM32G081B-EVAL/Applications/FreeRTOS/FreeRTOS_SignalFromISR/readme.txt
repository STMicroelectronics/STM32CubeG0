...
Each time the user presses the Tamper push-button, generating an interrupt,  an osSignal is sent 
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_SignalFromISR/Inc/stm32g0xx_it.h               Interrupt handlers header file
