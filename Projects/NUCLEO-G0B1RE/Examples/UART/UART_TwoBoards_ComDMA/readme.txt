...
Board: NUCLEO-G0B1RE (embeds a STM32G0B1RETx device)
...
NUCLEO-G0B1RE board LED is used to monitor the transfer status:
...
@par Hardware and Software environment
  ...
  - This example has been tested with two NUCLEO-G0B1RE boards embedding
    a STM32G0B1RETx device and can be easily tailored to any other supported device 
