...
This example demonstrates how to use the NUCLEO-G0B1RE board to blink an LED at different speeds when the user button is pressed.
...
@note The GPIO_Demo example provides the source code for the demonstration binary package, which can be downloaded
      from the NUCLEO-G0B1RE webpage. For more details, please see the Binary Resources section here:
      https://www.st.com/en/evaluation-tools/nucleo-g0b1re.html#tools-software
...
@par Directory contents 
  ...
  - GPIO/GPIO_EXTI/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - GPIO/GPIO_EXTI/Inc/stm32g0xx_it.h          Interrupt handlers header file
  - GPIO/GPIO_EXTI/Inc/main.h                  Header for main.c module  
  - GPIO/GPIO_EXTI/Src/stm32g0xx_it.c          Interrupt handlers
  - GPIO/GPIO_EXTI/Src/stm32g0xx_hal_msp.c     HAL MSP file
  - GPIO/GPIO_EXTI/Src/main.c                  Main program
  - GPIO/GPIO_EXTI/Src/system_stm32g0xx.c      STM32G0xx system source file
