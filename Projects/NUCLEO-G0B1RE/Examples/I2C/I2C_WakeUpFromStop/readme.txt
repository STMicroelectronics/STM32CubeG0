...
SCL Pin: PA9 (CN10, pin21)
SDA Pin: PA10 (CN10, pin33)
...
NUCLEO-G0B1RE's LEDs can be used to monitor the transfer status on the Master Board :
...
@par Hardware and Software environment
  ...
  - NUCLEO-G0B1RE Set-up
    ...
    - Connect I2C_SCL line of Master board (PA9, CN10, pin21) to I2C_SCL line of Slave Board (PA9, CN10, pin21).
    - Connect I2C_SDA line of Master board (PA10, CN10, pin33) to I2C_SDA line of Slave Board (PA10, CN10, pin33).
