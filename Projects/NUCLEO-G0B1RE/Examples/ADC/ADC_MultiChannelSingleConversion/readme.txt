...
Board settings:
 ...
 - The voltage input on the ADC external channel can be provided by an external source
   connected to Arduino connector CN8 pin A2, Morpho connector CN7 pin 32.



NUCLEO-G0B1RE board LED is be used to monitor the program execution status:
...
@par Directory contents 
  ...
  - ADC/ADC_MultiChannelSingleConversion/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  ...
  - ADC/ADC_MultiChannelSingleConversion/Inc/stm32g0xx_conf.h        HAL configuration file
