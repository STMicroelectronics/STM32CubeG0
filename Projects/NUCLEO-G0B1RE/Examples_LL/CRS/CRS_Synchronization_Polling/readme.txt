...
STM32G0xx CRS LL API. The peripheral initialization uses LL unitary
...
@par Directory contents 
  ...
  - CRS/CRS_Synchronization_Polling/Inc/stm32g0xx_it.h          Interrupt handlers header file
  ...
  - CRS/CRS_Synchronization_Polling/Src/stm32g0xx_it.c          Interrupt handlers
  - CRS/CRS_Synchronization_Polling/Src/main.c                  Main program
  - CRS/CRS_Synchronization_Polling/Src/system_stm32g0xx.c      STM32G0xx system source file
...
@par Hardware and Software environment
  ...
  - NUCLEO-G0B1RE Set-up
    - Connect the MCO pin to an oscilloscope to monitor HSI48 frequency:
      - PA.08: connected to pin 23 of CN10 connector for Nucleo-64  (MB1360)
