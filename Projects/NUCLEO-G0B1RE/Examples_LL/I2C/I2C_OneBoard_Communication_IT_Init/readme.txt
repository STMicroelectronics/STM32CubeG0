...
to configure GPIO and I2C peripherals using only one NUCLEO-G0B1RE.
...
@par Hardware and Software environment
  ...
  - NUCLEO-G0B1RE Set-up
    ...
    to respectively SCL and SDA pins of I2C3 (PC.0 and PC.1).
      - I2C1_SCL  PB.8 (CN10, pin 3) : connected to I2C3_SCL PC.0 (CN10, pin 18)
      - I2C1_SDA  PB.9 (CN10, pin 5) : connected to I2C3_SDA PC.1 (CN10, pin 16)
