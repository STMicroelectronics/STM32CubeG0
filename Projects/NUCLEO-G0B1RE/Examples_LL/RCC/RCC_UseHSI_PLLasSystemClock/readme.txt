...
set to 10MHz) and PLL with HSI as clock source (SYSCLK set to 64MHz). 
LED4 will toggle differently between the 2 configurations (quick toggle with SYSCLK configuration at 64MHz).
