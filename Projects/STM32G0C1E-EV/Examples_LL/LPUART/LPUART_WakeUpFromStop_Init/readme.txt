...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up
    - Connect STM32 MCU board LPUART2 TX pin (GPIO PB6 connected to pin 3 of CN2 connector)
      to PC COM port RX signal
    - Connect STM32 MCU board LPUART2 RX pin (GPIO PB7 connected to pin 4 of CN2 connector)
