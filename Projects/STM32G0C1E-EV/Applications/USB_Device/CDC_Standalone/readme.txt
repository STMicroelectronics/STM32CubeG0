...
Communication Class (CDC) following the PSTN sub-protocol on the STM32G0C1E-EV devices.

This example is part of the USB Device Library package using STM32Cube firmware.
This is a typical application on how to use the STM32G0C1xx USB Device peripheral where the STM32 MCU
...
To run this application, the user can use one of the following configuration:
 ...
 - Configuration 2:
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the STM32G0C1E-EV board
...
@par Directory contents
  ...
  - USB_Device/CDC_Standalone/Core/Src/system_stm32g0xx.c         STM32G0xx system clock configuration file
  - USB_Device/CDC_Standalone/Core/Src/stm32g0xx_it.c             Interrupt handlers
  - USB_Device/CDC_Standalone/Core/Src/stm32g0xx_hal_msp.c        HAL MSP Module
  ...
  - USB_Device/CDC_Standalone/Core/Inc/stm32g0xx_it.h             Interrupt handlers header file
  - USB_Device/CDC_Standalone/Core/Inc/stm32g0xx_hal_conf.h       HAL configuration file
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM32G0C1E-EV.
    board and can be easily tailored to any other supported device and development board.

  - STM32G0C1E-EV Set-up
  - Connect the STM32G0C1E-EV board CN7 to the PC through "TYPE-C" to "Standard A" cable.
  - For loopback mode test: connect directly USART3 TX and RX pins,
    - Connect STM32 MCU board USART3 TX pin (GPIO PC.11) to PC COM port RX signal
    - Connect STM32 MCU board USART3 RX pin (GPIO PC.10) to PC COM port TX signal

  The USART3 interface available on PC10 and PC11 of the microcontroller can be
