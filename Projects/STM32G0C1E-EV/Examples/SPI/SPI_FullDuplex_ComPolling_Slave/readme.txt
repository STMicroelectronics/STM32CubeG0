...
Board: STM32G0C1E-EV (embeds a STM32G0C1E device)
CLK Pin: PB3 (CN9 pin 21)
MISO Pin: PB4 (CN9 pin 22)
MOSI Pin: PB5 (CN3 pin 11)
...
In a first step after the user press the Tamper push-button, SPI Master starts the
...
STM32 board's LEDs can be used to monitor the transfer status:
 - LED1 toggles quickly on master board waiting Tamper push-button to be pressed.
...
@par Directory contents 
  ...
  - SPI/SPI_FullDuplex_ComPolling_Slave/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - SPI/SPI_FullDuplex_ComPolling_Slave/Inc/stm32g0xx_it.h          Interrupt handlers header file
  - SPI/SPI_FullDuplex_ComPolling_Slave/Inc/main.h                  Header for main.c module  
  - SPI/SPI_FullDuplex_ComPolling_Slave/Src/stm32g0xx_it.c          Interrupt handlers
  - SPI/SPI_FullDuplex_ComPolling_Slave/Src/main.c                  Main program
  - SPI/SPI_FullDuplex_ComPolling_Slave/Src/system_stm32g0xx.c      stm32g0xx system source file
  - SPI/SPI_FullDuplex_ComPolling_Slave/Src/stm32g0xx_hal_msp.c     HAL MSP file
...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up
    - Connect Master board PB3 (CN9 pin 21) to Slave Board PB3 (CN9 pin 21)
    - Connect Master board PB4 (CN9 pin 22) to Slave Board PB4 (CN9 pin 22)
    - Connect Master board PB5 (CN3 pin 11) to Slave Board PB5 (CN3 pin 11)
