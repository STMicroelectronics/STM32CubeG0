...
SCL Pin: PA9 (CN3, pin3)
SDA Pin: PB9 (CN3, pin7)
...
STM32G0C1E-EV's LEDs can be used to monitor the transfer status:
...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up
    ...
    - Connect I2C_SCL line of Master board (PA9, CN3, pin3) to I2C_SCL line of Slave Board (PA9, CN3, pin3).
    - Connect I2C_SDA line of Master board (PB9, CN3, pin7) to I2C_SDA line of Slave Board (PB9, CN3, pin7).
