/**
  @page FDCAN_Com_IT_2_BOARDS FDCAN Communication IT example

  @verbatim
  ******************************************************************************
  * @file    FDCAN/FDCAN_Com_IT_2_BOARDS/readme.txt
  * @author  MCD Application Team
  * @brief   Description of the FDCAN_Com_IT_2_BOARDS example.
  ******************************************************************************
  * @attention
  *
...
On the other board, after receiving the message notification:
...
@par Directory contents
  ...
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Inc/stm32g0xx_it.h          Header for stm32g0xx_it.c
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Inc/main.h                  Header for main.c module
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Src/stm32g0xx_it.c          Interrupt handlers
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Src/main.c                  Main program
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Src/stm32g0xx_hal_msp.c     HAL MSP module
  - FDCAN/FDCAN_Com_IT_2_BOARDS/Src/system_stm32g0xx.c      stm32g0xx system source file
...
In order to make the program work, you must do the following :
  ...
  - Rebuild all files and load your image into target memory of each board
  - Run the example
