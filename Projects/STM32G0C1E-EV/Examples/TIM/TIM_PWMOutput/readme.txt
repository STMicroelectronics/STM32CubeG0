...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up
   Connect the following pins to an oscilloscope to monitor the different waveforms:
        - TIM1_CH1 : PA.08 (pin 1 in CN3 connector)
        - TIM1_CH2 : PA.09 (pin 3 in CN3 connector)
        - TIM1_CH3 : PA.10 (pin 4 in CN3 connector)
        - TIM1_CH4 : PA.11(pin 2 in CN10 connector : close the SB8)
