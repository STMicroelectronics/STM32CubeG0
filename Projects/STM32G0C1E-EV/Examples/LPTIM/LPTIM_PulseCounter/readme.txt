...
(1000 + 1) rising edges on LPTIM Input pin PC0, an interrupt is generated and LED1
toggles.
...
@par Directory contents
  ...
  - LPTIM/LPTIM_PulseCounter/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - LPTIM/LPTIM_PulseCounter/Inc/stm32g0xx_it.h          Interrupt handlers header file
  - LPTIM/LPTIM_PulseCounter/Inc/main.h                  Header for main.c module  
  - LPTIM/LPTIM_PulseCounter/Src/stm32g0xx_it.c          Interrupt handlers
  - LPTIM/LPTIM_PulseCounter/Src/main.c                  Main program
  - LPTIM/LPTIM_PulseCounter/Src/stm32g0xx_hal_msp.c     HAL MSP module
  - LPTIM/LPTIM_PulseCounter/Src/system_stm32g0xx.c      STM32G0xx system source file
...
@par Hardware and Software environment
  ...
  - Generate pulses on PC0 (pin 36 in CN10 connector). (Connect a square waveform).
