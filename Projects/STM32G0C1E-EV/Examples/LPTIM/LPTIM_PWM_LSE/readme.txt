...
The SystemClock_Config() function is used to configure the system clock for STM32G0C1VETx Devices :
The CPU at 64 MHz 
...
Tamper push-button pin (PC.13)is configured as input with external interrupt (EXTI_Line4_15),
...
@par Directory contents
  ...
  - LPTIM/LPTIM_PWM_LSE/Inc/stm32g0xx_hal_conf.h    HAL configuration file
  - LPTIM/LPTIM_PWM_LSE/Inc/stm32g0xx_it.h          Interrupt handlers header file
  - LPTIM/LPTIM_PWM_LSE/Inc/main.h                  Header for main.c module  
  - LPTIM/LPTIM_PWM_LSE/Src/stm32g0xx_it.c          Interrupt handlers
  - LPTIM/LPTIM_PWM_LSE/Src/main.c                  Main program
  - LPTIM/LPTIM_PWM_LSE/Src/stm32g0xx_hal_msp.c     HAL MSP module
  - LPTIM/LPTIM_PWM_LSE/Src/system_stm32g0xx.c      STM32G0xx system source file
...
@par Hardware and Software environment
  ...
  - Connect PA0 (pin 32 in CN10 connector) to an oscilloscope to monitor the LPTIM1 output waveform.
