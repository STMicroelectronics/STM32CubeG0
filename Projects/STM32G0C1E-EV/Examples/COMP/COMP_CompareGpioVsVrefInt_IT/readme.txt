...
In this example, the comparator input is connected on pin PB2 (connected on CN10 pin 22).
...
@par Hardware and Software environment 
  ...
  - Apply an external variable voltage on PB2 (connected on CN10 pin 22) with average voltage 1.22V.
    Pin PB2 is also connected to potentiometer VDD_ANA, it can be used to provide variable voltage to comparator input.
