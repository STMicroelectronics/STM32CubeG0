...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up :
    - Jumper JP17 has to be on VDD_ADJ position 
    - Target has to be supplied by DC 5V through CN18 connector.
    - Power Supply can be adjusted thanks to the potentiometer VDD_ADJ/RV2 [1.65V to 3.61V]
    - LED1 (GREEN) connected to PD.05 pin indicates the behavior of
