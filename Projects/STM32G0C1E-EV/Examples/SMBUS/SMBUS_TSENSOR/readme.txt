...
STM32G0C1E-EV's Messages and LEDs can be used to monitor the temperature sensor status:
...
@par Hardware and Software environment
  ...
  - STM32G0C1E-EV Set-up
    - Make sure daughter board MB1351 is plugged on top mother board MB1581-G0C1E.
@par How to use it ? 
