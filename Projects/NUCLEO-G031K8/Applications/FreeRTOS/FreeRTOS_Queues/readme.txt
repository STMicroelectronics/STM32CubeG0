...
NUCLEO-G031K8's LEDs can be used to monitor the application status:
  - LED3 should toggle as soon as the producer posts a
    message on the queue (every 1 second).
  - LED3 should be continuously ON as soon as an error occurs.
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_Queues/Src/stm32g0xx_hal_timebase_tim.c HAL timebase file
    - FreeRTOS/FreeRTOS_Queues/Src/stm32g0xx_it.c               Interrupt handlers
	- FreeRTOS/FreeRTOS_Queues/Src/stm32g0xx_hal_msp.c          MSP Initialization file
    - FreeRTOS/FreeRTOS_Queues/Src/system_stm32g0xx.c           STM32G0xx system clock configuration file
    - FreeRTOS/FreeRTOS_Queues/Inc/main.h                       Main program header file
    - FreeRTOS/FreeRTOS_Queues/Inc/stm32g0xx_hal_conf.h         HAL Library Configuration file
    - FreeRTOS/FreeRTOS_Queues/Inc/stm32g0xx_it.h               Interrupt handlers header file
    - FreeRTOS/FreeRTOS_Queues/Inc/FreeRTOSConfig.h             FreeRTOS Configuration file

@par Hardware and Software environment

  - This application runs on STM32G031K8Tx devices.
    
  - This application has been tested with NUCLEO-G031K8 board and can be
