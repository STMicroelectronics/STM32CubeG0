...
STM32G0316-DISCO's LEDs can be used to monitor the application status:
...
@par Hardware and Software environment
  ...
  - This application runs on STM32G031J6Mx devices.
    
  - This application has been tested with STM32G0316-DISCO board and can be
